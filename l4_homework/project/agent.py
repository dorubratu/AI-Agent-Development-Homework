"""Document Analyst agent — ReAct loop with RAG tool wired in.

Extinde agentul din L1-L2 cu search_documents (RAG peste pgvector). LLM-ul
decide singur când să-l apeleze pe baza descrierii din tool catalog.
"""
...
class DocumentAnalystAgent:
    ...
    def _build_system(self) -> list[dict]:
        text = self.prompts.render(
            "planner_rag",
            role="Document analyst with RAG access",
...
def main() -> None:
    ...
    questions = [
        "Ce clauze de reziliere avem în contracte?",
        "Care este totalul facturii FAC-2026-042?",
        "Ce penalități sunt menționate pentru întârzieri la plată?",
    ]
